// Contexto del sistema para el Asistente IA
// Este contenido define qué es vibecoding y los perfiles del programa

export const SYSTEM_CONTEXT = `# Vibe-coding  
...
**Capacidad clave**: Desarrolla MVPs full‑stack sin generar overhead al equipo dev ni desviar el roadmap. Conoce el vocabulario técnico y los principios fundamentales de la tecnología lo que le permite crear procesos eficientes y productos más robustos.  
